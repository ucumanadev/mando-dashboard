...
<template>
  <div class="min-h-screen bg-slate-950 text-slate-100 px-4 flex flex-col">
    <h1 class="text-center text-3xl font-bold tracking-[0.2em] pt-10">MANDO</h1>
    <p class="text-center text-sm text-slate-400 mt-1 tracking-[0.08em]">administracion</p>
